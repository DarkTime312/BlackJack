...
def main():
    def frame_generator(parent, *, name):
        class PlayerFrame(ctk.CTkFrame):
            ...
            def busted(self):
                return int(self.score_label.cget('text')) > 21
    ...
    class BlackJack(ctk.CTk):
        ...
        def initialize_game(self):
            ...
            self.button3 = ctk.CTkButton(self.buttons_frame, text='Stand', command=self.player_frame.place_a_card, font=self.buttons_font)
            ...
            self.new_game_btn.grid(row=0, column=3, padx=5)
